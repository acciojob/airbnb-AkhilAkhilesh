...
public class HotelManagementController {
    ...
    public Integer addUser(@RequestBody User user){
        ...
        return userService.addUserintodb(user);
        //return null;
    }
    ...
    public String getHotelWithMostFacilities(){
        ...
        return hotelService.hotelwithmostfecilities();
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        return userService.userbookings(aadharCard);
    ...
    public Hotel updateFacilities(@RequestBody List<Facility> newFacilities,@RequestParam String hotelName){
        ...
        return hotelService.updatehotelfecilities(newFacilities,hotelName);
        //return null;
    }
